...
export const ArrowIcon: React.FC<{ width?: number; height?: number }> = ({ width = 25, height = 24 }) => (
  <svg width={width} height={height} viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.25 4L10.84 5.41L16.42 11H4.25V13H16.42L10.84 18.59L12.25 20L20.25 12L12.25 4Z" fill="#8DD3BB"/>
  </svg>
);

export const CalendarIcon: React.FC<{ width?: number; height?: number }> = ({ width = 28, height = 29 }) => (
