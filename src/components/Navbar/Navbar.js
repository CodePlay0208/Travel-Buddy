              ...
              <div id="imgForUserProfile" onClick={handleClickOnProfilePic}>
                ...
                >
                  <g>
                    <g>
                      <path
                        d="M50,95.5c25.1,0,45.5-20.4,45.5-45.5S75.1,4.5,50,4.5S4.5,24.9,4.5,50S24.9,95.5,50,95.5z M50,27.6   
          c8.3,0,15.1,6.8,15.1,15.1c0,8.3-6.8,15.1-15.1,15.1S34.9,51,34.9,42.7C34.9,34.3,41.7,27.6,50,27.6z M24.3,86.3    
          C28,73,38.3,63.4,50.4,63.4c12,0,22.2,9.4,25.9,22.5c-7.4,5.4-16.5,8.6-26.3,8.6C40.4,94.5,31.6,91.5,24.3,86.3z"
                      />
                    </g>
                  </g>
                </svg>
                {showUserProfileDropDownList && (
                  <div className="userProfileDropDownList">
                    {userProfileDropDownData.map((data) => (
                      ...
                      >
                        <p className="listItemValueForUserProfileData" id="listItemValueForUserProfileData">
                          {data.value}
                        </p>
                      </li>
                    ))}
