    ...
    <div>
      ...
      <div className="publish-trip-form">
        ...
        <div className="input-element">
          ...
          <input className="publish-trips-input" type="text" placeholder="Enter Your Name"></input>
        </div>
        <div className="input-element">
          <label className="publish-trips-label">Start Location</label>
          <input className="publish-trips-input" type="text" placeholder="Enter Start Location"></input>
        </div>
        <div className="input-element">
          <label className="publish-trips-label">Destination</label>
          <input className="publish-trips-input" type="text" placeholder="Enter Destination"></input>
        </div>
        <div className="input-element">
          <label className="publish-trips-label">Phone Number</label>
          <input className="publish-trips-input" type="text" placeholder="Enter Your Phone Number"></input>
        </div>
        <div className="input-element">
        ...
        <div className="input-element">
          ...
          <input type="text" className="publish-trips-input" placeholder="Enter Current Total Members"></input>
        </div>
        <div className="input-element">
          <label className="publish-trips-label">Age</label>
          <input className="publish-trips-input" type="text" placeholder="Enter Your Age"></input>
        </div>
        <div className="input-element">
           <label for="input-file" className = "input-file-label">Upload Image</label>
           <input className="publish-trips-input" id="input-file" type="file" />
          </div>
        <div className="input-element">
          <label className="publish-trips-label">Gender</label>
          <input className="publish-trips-input" type="text" placeholder="Enter Your Gender"></input>
        </div>
        <div className="input-element">
          <label className="publish-trips-label">Description</label>
          <textarea className="publish-trips-textarea" placeholder="Enter Your Trip's Description"></textarea>
        </div>
        <div className="input-element">
