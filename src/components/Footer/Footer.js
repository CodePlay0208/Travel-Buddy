...
const Footer = () => {
  const { topDestinations, setTopDestinations } = useContext(
    TopDestinationsContext
  );
        ...
        <div className="top-destinations">
          ...
          <ul>
            {topDestinations.map((destination, idx) => (
              <li
                key={idx}
                className="li-top-destinations"
                onClick={/*TODO*/ console.log("Hey")}
              >
                {destination}
              </li>
            ))}
