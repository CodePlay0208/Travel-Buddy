...
import { H1Item, LandingContainer } from '../../styles/LandingPage.styled'
...
const LandingPage = (props) => {
  ...
  return (
    <div className="LandingContainer">
      ...
      <H1Item>From Dreaming to Departing - We Have Got Your Travel Plans Sorted!</H1Item>
      </Container>
      ...
      <PopularSection />
      <TopDestination />
      <QuesAns heading="Why travel agencies Travmigos for the packages?" data={data} />
      <Newsletter />
      <Footer />
    </div>
  )
